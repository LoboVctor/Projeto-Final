...
export class CriarUsuarioDto {
  ...
  @ApiPropertyOptional({
    example: 'b148ad4a-1111-46bb-80d5-1234567890ab',
    description:
      'ID opcional do educador caso este usuário represente um educador',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'c148ad4a-2222-46bb-80d5-1234567890ab',
    description:
      'ID opcional do responsável caso este usuário represente um responsável',
  })
  @IsOptional()
